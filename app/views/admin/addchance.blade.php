...
@endif
{{ Form::open(array("url"=>route('addchance1'),"class"=>"form-horizontal" ,'files' => true)) }}
...
<div class='form-group'>
        ...
        <div class='col-sm-8'>{{ Form::select('category',array("Internship"=>"Internship","Job"=>"Job","Volunteers"=>"Volunteers","Tenders"=>"Tenders","Consultancy"=>"Consultancy",),'',array('class'=>'form-control')) }}  </div>
    </div>
