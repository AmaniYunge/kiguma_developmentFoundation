...
@endif
{{ Form::open(array("url"=>route('addresources'),"class"=>"form-horizontal" ,'files' => true)) }}
...
<div class='form-group'>
    ...
    <div class='col-sm-8'>{{ Form::select('category',array("Annual Reports"=>"Annual Reports","Financial Report"=>"Financial Report","Strategic Plan"=>"Strategic Plan","Brochures"=>"Brochures",),'',array('class'=>'form-control')) }}  </div>
</div>
...
<div class='form-group'>
    {{ Form::label('img1', 'File(Not more than 10Mb',array('class'=>'control-label col-sm-4')) }}
