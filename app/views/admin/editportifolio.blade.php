...
@endif
{{ Form::open(array("url"=>route('editportifolio1'),"class"=>"form-horizontal" ,'files' => true)) }}
...
<div class='form-group'>
    <label class="control-label col-sm-4">{{ HTML::image("uploads/rooms/{$post->image}","",array("style"=>"width:100px;height:100px")) }}</label>
