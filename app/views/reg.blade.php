...
<section id="about-us" class="container main">
    <div class="row-fluid">
        ...
        <div class="span8 pull-right">
            <h2 style="text-align: center">Registration Certificate</h2>
            <div>
                <img class="img-rounded img- thumbnail icon-align-center"  alt=" " src="{{asset('images/portfolio/thumb/reg.jpg')}}" style="width: 840px; height: 600px">
            </div>
        </div>
    </div>
